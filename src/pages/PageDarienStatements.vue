  ...
  <q-page>
    <div class="row justify-around">
      <div class="col-11 column">
        ...
        <div class="ds-byline">
          <h5>Written by John Blyberg, Kathryn Greenhill, and Cindi Trainor</h5>
          <p class="text-italic">Originally published April 3, 2009</p>
        </div>

        <div>
          <div class="ds-section">
            <div class="ds-subtitle">
              <h5>The Purpose of the Library</h5>
            </div>
            <p>
              The purpose of the Library is to preserve the integrity of
              civilization.
            </p>

            <p>
              The Library has a moral obligation to adhere to its purpose
              despite social, economic, environmental, or political influences.
              The purpose of the Library will never change.
            </p>

            <p>
              The Library is infinite in its capacity to contain, connect and
              disseminate knowledge; librarians are human and ephemeral,
              therefore we must work together to ensure the Library’s
              permanence.
            </p>

            <p>
              Individual libraries serve the mission of their parent institution
              or governing body, but the purpose of the Library overrides that
            ...
            <p>
              A clear understanding of the Library’s purpose, its role, and the
              role of librarians is essential to the preservation of the
              Library.
            </p>
          </div>
          ...
          <div class="ds-section">
            <div class="ds-subtitle">
              <h5>The Preservation of the Library</h5>
            </div>
            <p>
              Our methods need to rapidly change to address the profound impact
              of information technology on the nature of human connection and
              the transmission and consumption of knowledge.
            </p>

            <p>
              If the Library is to fulfill its purpose in the future, librarians
              must commit to a culture of continuous operational change, accept
              risk and uncertainty as key properties of the profession, and
              uphold service to the user as our most valuable directive.
            </p>

            <h6>As librarians, we must:</h6>
            ...
            <p>
              We have faith that the citizens of our communities will continue
              to fulfill their civic responsibility by preserving the Library.
            </p>
          </div>
        </div>
      </div>
